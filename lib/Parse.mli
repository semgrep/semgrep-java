...
(**
    Functions for parsing java programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a java program from a string into a typed OCaml CST.
...
(** Parse a java program from a file into a typed OCaml CST.
